...
export default function Model(props) {
  const { nodes, materials } = useGLTF('https://rhouzf.github.io/react-3d-model/docs/assets/d.gltf')
  return (
...
useGLTF.preload('https://rhouzf.github.io/react-3d-model/docs/assets/d.gltf')
